...
#define UART2_TX PORTE,16,3			// wybieramy pin nadajnika UART    port,numer pinu,wartość multipleksera
#define UART2_RX PORTE,17,3			// wybieramy pin odbiornika UART   port,numer pinu,wartość multipleksera

#define TX_BUFOR_SIZE 512
